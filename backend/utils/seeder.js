...
const CATEGORIES = [
  ...
  { id: "headphones", name: "Headphones", icon: "Headphones", count: 0, image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=600&auto=format&fit=crop" },
  { id: "smartwatches", name: "Smartwatches", icon: "Watch", count: 0, image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=600&auto=format&fit=crop" },
  { id: "accessories", name: "Accessories", icon: "Keyboard", count: 0, image: "https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?q=80&w=600&auto=format&fit=crop" },
  { id: "clothing", name: "Clothing", icon: "Shirt", count: 0, image: "https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?q=80&w=600&auto=format&fit=crop" },
  { id: "shoes", name: "Shoes", icon: "Footprints", count: 0, image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=600&auto=format&fit=crop" }
];
...
const seedData = async () => {
  try {
    ...
    // Create Categories
    await Category.insertMany(calculatedCategories);
    ...
    const admin = await User.create({
      ...
      password: "QuickCartAdminSecured2026!", // Hashes automatically via pre-save hook
      role: "admin",
