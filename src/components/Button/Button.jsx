...
export const Button = ({
  ...
  const variants = {
    primary: "bg-primary hover:bg-primary-dark text-white dark:bg-black dark:text-white dark:border dark:border-white dark:hover:bg-neutral-900/50 dark:shadow-none shadow-lg shadow-primary/10 hover:shadow-primary/20",
    secondary: "bg-gradient-to-r from-primary to-secondary text-white dark:bg-black dark:text-white dark:border dark:border-neutral-800 dark:hover:bg-neutral-900/50 dark:shadow-none hover:brightness-105 shadow-md shadow-secondary/10",
